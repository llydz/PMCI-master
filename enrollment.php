                    ...
                    <div class="calendar">
                        <div class="date">
                            ...
                            <input type="text" name="appointdate" id="appointdate" class="datepicker"
                                value="<?php echo @$_POST['appointdate']; ?>" required>
                        ...
                        <p class="avail" id="avail" style="display: none; width: 100%; text-align: center">Appointment
                            available!</p>
                        <p class="avail" id="novalue" style="display: none; width: 100%; text-align: center">Date or
                            Time is required</p>

                    </div>
                    <div class="submit">
                        <button type="button" name="checkAppointment" class="checkAppointment" id="checkAppointment"
                            onclick="check()">CHECK APPOINTMENT</button>
